...
class PlatoModel(nn.Module):
    ...
    def forward(
            ...
            return_dict=False):
        # print("=============input_ids=============")
        # print(input_ids.shape) # torch.Size([100, 512])
        ...
        # print("=============embed=============")
        # print(embed.shape) # torch.Size([100, 512, 768])
        embed = self.embed_layer_norm(embed) # 임베딩에 레이어 정규화(Layer Normalization)를 적용
        
        all_hidden_states = ()
        for layer in self.layers:
            mask = self._create_mask(attention_mask, auto_regressive=False, append_head=False)
            # print("=============mask=============")
            # print(mask.shape) # torch.Size([100, 512, 512])
        ...
        # print("=============all_hidden_states (after)=============")
        # print(len(all_hidden_states)) #12
        # for hidden_state in all_hidden_states:
        #     print(hidden_state.shape) # torch.Size([100, 512, 768])
