...
class WrapperBert:
    ...
    def eval_tasks(
        ...
        # # 3개 평가지표 중 2개가 기존 성능보다 높으면 is_best Ture 반환
        # is_best_conditions = sum([evaluation_result.purity > best_evaluation_result.purity, 
        #                       evaluation_result.SR > best_evaluation_result.SR,
        #                       evaluation_result.MAP > best_evaluation_result.MAP
        #                     ])
        # is_best = True if is_best_conditions >= 2 else False
...
if __name__ == '__main__':
    ...
    ## Optimization
    parser.add_argument("--train_batch_size", default=10, type=int, help='Be careful when using multi-gpu.')
